...
extension Double {
    ...
    /// Converts a Double into a Currensy with 2-6 decimal places
    /// ```
    ...
    /// Converts a Double into a Currensy as a String with 2-6 decimal places
    /// ```
    /// Convert 1234.56 to "$ 1,234.56"
