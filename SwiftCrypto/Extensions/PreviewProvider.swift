...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "$12.5bn", percentageChange: 24.24)
    let stat2 = StatisticModel(title: "Total Valume", value: "$1.23 Bn")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "$50 k", percentageChange: -12.34)
